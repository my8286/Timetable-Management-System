...
<body class="skin-blue">
				...
				<ul class="sidebar-menu">
						...
						<li class="treeview">
							...
							<ul class="treeview-menu">
								...
								<li><a href="pages/forms/roomform.php"><i class="fa fa-circle-o"></i> Room </a></li>
							</ul>
						</li>
						<li class="treeview">
							<a href="#">
            ...
            <section class="col-lg-12">
			  ...
			  <!-- Tabs within a box -->
                <ul class="nav nav-tabs pull-right">
                  <li><a href="adminsc.php"> Science</a></li>
                  <li class="active"><a href="#"> All</a></li>
                  <li class="pull-left header"><i class="fa fa-inbox"></i> Time Table <small id="label"></small></li>
                </ul>
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													<label for="subject">
														Type</label>
													<select id="type" name="type" class="form-control" onchange="subTypeRoom()">
											...
											<div class="col-md-12">
												<button type="submit" class="btn btn-primary pull-right" name="adminAll" id="btnContactUs">
												Submit</button>
											</div>
										</div>
									</form>
	...
	<script>
	//--------------------------------------------
	$(document).on('checked', '#dept',function(){
		var dept = $(this).val();
		var label=$("#dept option:selected").text();
		label=label+"("+ dept.toUpperCase() +")";
		$("#label").text(label);
		if(dept != 'default')
		{
			load_data(dept,dept);
