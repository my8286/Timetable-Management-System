...
/*----------------------------------------------------*/
  ...
  <body class="skin-blue sidebar-collapse fixed">
          ...
          <!-- sidebar menu: : style can be found in sidebar.less -->
						...
						<li class="treeview">
							...
							<ul class="treeview-menu">
								...
								<li><a href="../hodforms/roomform.php"><i class="fa fa-circle-o"></i> Room </a></li>
							</ul>
						</li>
              ...
              <div class="box" style="overflow-x: auto;">
                <div id="hide" class="box-header">
				  ...
				  <select id="year" onchange="timeTable()">
					...
					<select id="mail" style="margin-right:.2%" class="pull-right btn bg-blue" onchange="sendMail('mail')">
						<option value="default"><span class="glyphicon glyphicon-envelope"></span> Mail To</option>
						<?php 
                ...
                <div class="box-body">
                  <table id="example1" class="table border" style="background-color:black;color:white">
                    <thead class="border">
						<tr class="border">
							<th colspan=11 class="border"><center style="font-size:20px"><?php echo "Department of ".$department;?></center></th>
						</tr>
						<tr class="border">
	...
	<!----simple swap js-->
	<script src="../../dist/js/swap.js" type="text/javascript"></script>
	<script>
...
{	
	...
	else
	{
		...
		xhttp.open("GET", "../../plugins/timetable/mail.php?sendMail=1&&year="+year+"&&shift="+shift+"&&dept="+dept+"&&teacher="+teacher+"&&room="+room+"&&sem="+sem+"&&to="+mail+"&&val="+val, true);
		xhttp.send();
	}
}
