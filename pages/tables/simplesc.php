<?php
 ...
 if(isset($_SESSION['admin']))
 {
	...
	{	
		...
		$q=mysqli_query($con,"select * from teacher where designation='hod' and dept='sc'") or die (mysqli_error());
		...
		$q=mysqli_query($con,"select * from content where field='hod' and dept='sc'") or die (mysqli_error());
		while($row=mysqli_fetch_array($q))
		{
			$hodName=$row['value'];
		}
		$q=mysqli_query($con,"select * from content where field='principal' and dept='sc'") or die (mysqli_error());
		while($row=mysqli_fetch_array($q))
		{
			$prinName=$row['value'];
		}
		$q=mysqli_query($con,"select * from content where field='incharge' and dept='sc'") or die (mysqli_error());
		while($row=mysqli_fetch_array($q))
		{
			$incharge=$row['value'];
		}
          ...
          <!-- sidebar menu: : style can be found in sidebar.less -->
						...
						<li class="treeview">
							...
							<ul class="treeview-menu">
								<li><a href="../forms/userform.php"><i class="fa fa-circle-o"></i> User </a></li>
						...
						<li class="treeview">
							...
							<ul class="treeview-menu">
								<li class="active"><a href="simple.php"><i class="fa fa-circle-o"></i> Simple</a></li>
								<li class="active"><a href="master.php"><i class="fa fa-circle-o"></i> Master</a></li>
							</ul>
						</li>
						<li class="treeview">
							<a href="#">
                ...
                <div id="hide" class="box-header">
				  ...
				  <select id="year" onchange="timeTable('hodsc')">
					...
					<select id="mail" style="margin-right:.2%" class="pull-right btn bg-blue " onchange="sendMail()">
						...
						<?php 
							$q=mysqli_query($con,"select teacher_code,email from teacher where dept='sc'") or die (mysqli_error());
							while($row=mysqli_fetch_array($q))
							{?>
