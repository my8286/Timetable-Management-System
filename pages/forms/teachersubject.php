              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
					...
					$q=mysqli_query($con,"select DISTINCT ts.teacher_id,t.*,s.* from teacher_subject ts,teacher t,subject s where ts.teacher_id=t.teacher_id and s.subject_id=ts.subject_id and s.dept!='sc'") or die (mysqli_error());
