  ...
  <body class="skin-blue">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
					...
					{ ?>
                      <tr>
						...
						<td class="teacher" data-id="<?php echo $row['teacher_id'];?>" data-id2="password" type="password" contenteditable><?php if($row['password']!="") echo "********"; else echo "Not Set";?></td>
					</tr>
				<?php
					}?>				
    ...
    <script type="text/javascript">
	 ...
	 // selectDesignation();
	  function deptVal()
	  {
		  return document.getElementById("uDept").value;
	  }
	  function userPass()
		{
