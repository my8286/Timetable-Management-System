              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
						<tr>
							<td colspan=9><center>Teacher's</center></td>
						</tr>
                      <tr>
                        <th>Sr No.</th>
                        <th>First Name</th>
					...
					<?php 
					$i=0;
					$q=mysqli_query($con,"select * from teacher where designation='professor' ORDER BY designation ASC;") or die (mysqli_error());
