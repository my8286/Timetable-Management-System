					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown user user-menu">
							<a>
								...
								<span class="hidden-xs"><?php echo strtoupper($_SESSION['first_nameHOD'])." ".strtoupper($_SESSION['last_nameHOD']);?></span>
							</a>
						</li>
						<!---logout--->
              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
						<tr>
							<td colspan=9><center><?php echo "$department"; ?></center></td>
						</tr>
                      <tr>
                        <th>Sr No.</th>
                        <th>First Name</th>
					...
					<?php 
					$i=0;
					$q=mysqli_query($con,"select * from teacher where dept='$dept' and designation!='visitor' ORDER BY designation ASC;") or die (mysqli_error());
