											...
											<div class="col-md-4">
												...
												<div class="form-group">
													...
													<select class="form-control" id="des">
														...
														<option id="desPrin" value="principal">Principal</option>
														<option id="desHOD" value="hod">Head Of Department</option>
              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
					...
					<?php 
					$i=0;
					$q=mysqli_query($con,"select *from teacher where dept='$dept' ORDER BY designation ASC;") or die (mysqli_error());
					...
					{ ?>
                      <tr>
                        ...
                        <td class="teacher" data-id="<?php echo $row['teacher_id'];?>" data-id2="designation" contenteditable><?php if($row['designation']!='hod')echo ucfirst($row['designation']); else echo strtoupper($row['designation']);?></td>
