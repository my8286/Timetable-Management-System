        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
			...
			<li class="treeview active">
				...
				<ul class="treeview-menu ">
					<li class="active">
						<a href="#"><i class="fa fa-circle-o"></i>Teacher</a>
					</li>
					<li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="../../hod.php">Data table</a></li>
              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
						<tr>
							<td colspan=14><center><?php echo "$department"; ?></center></td>
						</tr>
                      <tr>
					...
					$q=mysqli_query($con,"select DISTINCT ts.teacher_id,t.*,s.* from teacher_subject ts,teacher t,subject s where t.dept='$dept' and ts.teacher_id=t.teacher_id and s.subject_id=ts.subject_id") or die (mysqli_error());
					...
					{ 
                      ...
                      <tr>
						<td><?php echo ++$i;?></td>
                        <td><?php echo strtoupper($row['teacher_code']);?></td>
                        ...
                        <td><?php 
								$count=0;
								$q2=mysqli_query($con,"select * from teacher_subject where teacher_id=$t_id and batch='a' and shift='fs' and subject_id=$s_id ") or die (mysqli_error());
						...
						<td><?php 
								$count=0;
								$q2=mysqli_query($con,"select * from teacher_subject where teacher_id=$t_id and batch='b' and shift='fs' and subject_id=$s_id ") or die (mysqli_error());
								while($row=mysqli_fetch_array($q2))
								{
									echo '<i class="fa fa-check lime"></i>';
									$count++; 
						...
						<td><?php 
								$count=0;
								$q2=mysqli_query($con,"select * from teacher_subject where teacher_id=$t_id and batch='c' and shift='fs' and subject_id=$s_id ") or die (mysqli_error());
								while($row=mysqli_fetch_array($q2))
								{
									echo '<i class="fa fa-check lime"></i>';
									$count++;
						...
						<td><?php 
								$count=0;
								$q2=mysqli_query($con,"select * from teacher_subject where teacher_id=$t_id and batch='null' and shift='fs' and subject_id=$s_id ") or die (mysqli_error());
								while($row=mysqli_fetch_array($q2))
								{
									echo '<i class="fa fa-check lime"></i>';
									$count++;
						...
						<td><?php 
								$count=0;
								$q2=mysqli_query($con,"select * from teacher_subject where teacher_id=$t_id and batch='a' and shift='ss' and subject_id=$s_id ") or die (mysqli_error());
								while($row=mysqli_fetch_array($q2))
								{
									echo '<i class="fa fa-check lime"></i>';
									$count++;
						...
						<td><?php 
								$count=0;
								$q2=mysqli_query($con,"select * from teacher_subject where teacher_id=$t_id and batch='b' and shift='ss' and subject_id=$s_id ") or die (mysqli_error());
								while($row=mysqli_fetch_array($q2))
								{
									echo '<i class="fa fa-check lime"></i>';
									$count++;
						...
						<td><?php 
								$count=0;
								$q2=mysqli_query($con,"select * from teacher_subject where teacher_id=$t_id and batch='c' and shift='ss' and subject_id=$s_id ") or die (mysqli_error());
								while($row=mysqli_fetch_array($q2))
								{
									echo '<i class="fa fa-check lime"></i>';
									$count++;
						...
						<td><?php 
								$count=0;
								$q2=mysqli_query($con,"select * from teacher_subject where teacher_id=$t_id and batch='null' and shift='ss' and subject_id=$s_id ") or die (mysqli_error());
								while($row=mysqli_fetch_array($q2))
								{
									echo '<i class="fa fa-check lime"></i>';
									$count++;
